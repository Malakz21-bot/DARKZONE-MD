...
module.exports = {
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "256787038917",  // Owner's WhatsApp number
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "Malakz Emmy",           // Owner's name
    ...
    REJECT_MSG: process.env.REJECT_MSG || "*📞🚨 This is a NO-CALL ZONE 🚨
...
Kindly text*",
    ...
    CUSTOM_REACT_EMOJIS: getConfig("CUSTOM_REACT_EMOJIS") || process.env.CUSTOM_REACT_EMOJIS || "🥰,💖,✌️,😎,🔥",  // set custom reacts
    ...
    MENU_IMAGE_URL: getConfig("MENU_IMAGE_URL") || "https://imgur.com/a/UszNxr1",  // Bot's "alive" menu mention image
